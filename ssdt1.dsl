 ...
 * 
 * Disassembly of ssdt1.dat, Sun Feb 15 07:13:03 2015
 *
...
DefinitionBlock ("ssdt1.aml", "SSDT", 1, "HASEE ", "PARADISE", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC__.AMBT)
    External (_SB_.PCI0.LPCB.EC__.CVRT)
    External (_SB_.PCI0.LPCB.EC__.DIM0)
    External (_SB_.PCI0.LPCB.EC__.DIM1)
    External (_SB_.PCI0.LPCB.EC__.ECOK, IntObj)
    External (_SB_.PCI0.LPCB.EC__.FANT)
    External (_SB_.PCI0.LPCB.EC__.FCMD)
    External (_SB_.PCI0.LPCB.EC__.GTVR)
    External (_SB_.PCI0.LPCB.EC__.MCRT)
    ...
    External (_SB_.PCI0.LPCB.EC__.PECH)
    ...
    External (_SB_.PCI0.LPCB.EC__.PMAX)
    External (_SB_.PCI0.LPCB.EC__.PMDT)
    External (_SB_.PCI0.LPCB.EC__.PPDT)
    ...
    External (_SB_.PCI0.LPCB.EC__.SKNT)
    External (_SB_.PCI0.LPCB.EC__.TSD0)
    External (_SB_.PCI0.LPCB.EC__.TSD1)
    External (_SB_.PCI0.LPCB.EC__.TSD2)
    External (_SB_.PCI0.LPCB.EC__.TSD3)
    ...
    Scope (\_SB)
    {
        Device (PTID)
        {
            ...
            Method (TSDD, 0, NotSerialized)
            {
                ...
                {
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.CVRT, 0x0A), 0x0AAC), Index (TMPV, 
                        0x02))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.GTVR, 0x0A), 0x0AAC), Index (TMPV, 
                        0x03))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.FANT, 0x0A), 0x0AAC), Index (TMPV, 
                        0x04))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.SKNT, 0x0A), 0x0AAC), Index (TMPV, 
                        0x05))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.AMBT, 0x0A), 0x0AAC), Index (TMPV, 
                        0x06))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.MCRT, 0x0A), 0x0AAC), Index (TMPV, 
                        0x07))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.DIM0, 0x0A), 0x0AAC), Index (TMPV, 
                        0x08))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.DIM1, 0x0A), 0x0AAC), Index (TMPV, 
                        0x09))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.PMAX, 0x0A), 0x0AAC), Index (TMPV, 
                        0x0A))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.PPDT, 0x0A), 0x0AAC), Index (TMPV, 
                        0x0B))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.PECH, 0x0A), 0x0AAC), Index (TMPV, 
                        0x0C))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.PMDT, 0x0A), 0x0AAC), Index (TMPV, 
                        0x0E))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.TSD0, 0x0A), 0x0AAC), Index (TMPV, 
                        0x0F))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.TSD1, 0x0A), 0x0AAC), Index (TMPV, 
                        0x10))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.TSD2, 0x0A), 0x0AAC), Index (TMPV, 
                        0x11))
                    Store (Add (Multiply (\_SB.PCI0.LPCB.EC.TSD3, 0x0A), 0x0AAC), Index (TMPV, 
                        0x12))
                }
