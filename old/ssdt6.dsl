 ...
 * 
 * Disassembly of ssdt6.dat, Sun Feb 15 07:13:03 2015
 *
...
DefinitionBlock ("ssdt6.aml", "SSDT", 1, "HASEE ", "PARADISE", 0x00001000)
{
    ...
    External (GBAS, MethodObj)    // Warning: Unresolved Method, guessing 1 arguments (may be incorrect, see warning above)
    External (XBAS, MethodObj)    // Warning: Unresolved Method, guessing 1 arguments (may be incorrect, see warning above)

    External (_SB_.PCI0.GFX0._DOD, IntObj)
    External (_SB_.PCI0.LPCB.EC__.DGPU)
    ...
    Scope (\_SB.PCI0.PEG0)
    {
        ...
        {
            Store (Add (Add (\XBAS (0x8000), Zero, Arg0), Zero, Local7), OperationRegion (PCI0, SystemMemory, 
                Local7, One))
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        OperationRegion (GPR2, SystemIO, \GBAS (0x60), Field (GPR2, ByteAcc, Lock, Preserve)
            {
                Offset (0x0C), 
                Offset (0x0F), 
                GP24,   1, 
